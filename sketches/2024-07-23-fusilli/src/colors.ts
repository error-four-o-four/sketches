import type { Coords, ProcessedNodeHash } from "./types.js";
...
export class Colors {
	...
	process(nodes: ProcessedNodeHash[]) {
...
function createHSLColorGenerator(config: ConfigHsl, data: ProcessedNodeHash[][]) {
